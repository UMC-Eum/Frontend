...
export function ChatPlusMenu({ onCameraClick, onAlbumClick }: ChatPlusMenuProps) {
  return (
      ...
      <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={onCameraClick}>
        <div className="w-[42px] h-[42px] bg-[#E9ECED] rounded-full flex items-center justify-center transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M14.3486 4C14.9706 4 15.557 4.28967 15.9355 4.7832L17.2305 6.4707H20C21.1046 6.4707 22 7.36613 22 8.4707V18C22 19.1046 21.1046 20 20 20H4C2.96435 20 2.113 19.2128 2.01074 18.2041L2 18V8.4707C2 7.36613 2.89543 6.4707 4 6.4707H6.76953L8.06445 4.7832C8.44295 4.28967 9.02941 4 9.65137 4H14.3486ZM12 9C9.79086 9 8 10.7909 8 13C8 15.2091 9.79086 17 12 17C14.2091 17 16 15.2091 16 13C16 10.7909 14.2091 9 12 9ZM19 9C18.4477 9 18 9.44772 18 10C18 10.5523 18.4477 11 19 11C19.5523 11 20 10.5523 20 10C20 9.44772 19.5523 9 19 9Z" fill="#636970"/>
    ...
    {/* 2. 앨범 아이콘 */}
    {/* viewBox를 0 0 14 14로 수정하여 아이콘 크기를 키움 */}
