    ...
    <>
      ...
      <div className="ml-5 mt-2 flex items-center gap-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-[14px] font-medium leading-[1.2] text-gray-600">{user?.area.name}</span>
        </div>
      </div>
      {/* 내 프로필 - 프로필 변경 */}
      {isImageModalOpen && (
      ...
      <div className="mt-5 mb-6">
        <h2 className="px-5 pt-3 pb-4 text-[20px] font-semibold leading-[1.2]">나의 소개</h2>
      ...
      <div className="flex flex-col gap-[10px] mb-6">
        <div className="px-5 pt-3 pb-4 flex w-full justify-between items-center">
          <h2 className="text-[20px] font-semibold leading-[1.2]">나의 관심사</h2>
      ...
      <div className="flex flex-col gap-[20px] mb-6">
        <div className="px-5 pt-3 pb-4 flex w-full justify-between items-center">
          <h2 className="text-[20px] font-semibold leading-[1.2]">나는 이런 사람이에요.</h2>
        ...
        <div className="flex items-center justify-center">
          ...
          >
            ...
            <span className="text-white text-[18px] font-semibold leading-[1.2] tracking-normal">재녹음</span>
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-[20px] mb-6">
        <div className="px-5 pt-3 pb-4 flex w-full justify-between items-center">
          <h2 className="text-[20px] font-semibold leading-[1.2]">나의 이상형</h2>
        ...
        {user?.idealPersonalities.length === 0 && (
          <div className="mx-5 py-[15px] px-5 flex items-center justify-between rounded-2xl bg-gradient-to-r from-[#FEC4D1] to-[#FFF0E5]">
            <span className="text-[16px] font-medium leading-[1.4] tracking-normal text-gray-800">
              지금 바로 <span className="font-semibold text-[#FF3D77]">이상형 등록</span>하고{" "}
      ...
      <div className="flex flex-col gap-2 mb-6">
        <h2 className="px-5 pt-3 pb-4 text-[20px] font-semibold leading-[1.2]">기본 정보</h2>
        
        <div className="px-5 flex flex-col gap-3">
          <div className="flex items-center gap-[28px]">
            <dt className="text-[16px] font-medium leading-[1.2] text-gray-700 tracking-normal">성별</dt>
            <dd className="text-[16px] font-medium leading-[1.2] text-gray-500 tracking-normal">{user?.gender}</dd>
          </div>

          <div className="flex items-center gap-[28px]">
            <dt className="text-[16px] font-medium leading-[1.2] text-gray-700 tracking-normal">나이</dt>
          ...
          <div className="flex w-full justify-between tems-center gap-[28px]">
            <dt className="text-[16px] font-medium leading-[1.2] text-gray-700 tracking-normal">지역</dt>
            <dd className="text-[16px] font-medium leading-[1.2] text-gray-700 tracking-normal">{user?.area.name}</dd>
            <NextArrow navigateTo="./ideal" />
          </div>
        </div>
...
const pauseIcon = (
  ...
  return (
    <div className="mx-5 pl-[10px] py-2 gap-3 flex items-center border border-gray-300 rounded-full">
      ...
      <Waveform paused={!isPlaying} reset={!isPlaying && audioRef.current?.currentTime === 0} />
      <img src={volume_btn} />
    </div>
  );
};
